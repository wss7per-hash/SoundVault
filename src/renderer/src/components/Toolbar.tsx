        ...
        {showLibMenu && (
          <div className="absolute left-0 top-full mt-2 w-64 bg-surface-panel border border-surface-border rounded-xl shadow-2xl py-2 z-50">
            ...
            >
              ...
              <div className="text-left">
              <div>备份元数据</div>
              <div className="max-h-0 opacity-0 overflow-hidden group-hover:max-h-20 group-hover:opacity-100 transition-all duration-200 text-[10px] text-muted/60 leading-relaxed">把标签、备注、收藏夹、智能文件夹导出为 JSON 文件，方便迁移或灾备（不含音频文件本身）</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
              <div>恢复元数据</div>
              <div className="max-h-0 opacity-0 overflow-hidden group-hover:max-h-20 group-hover:opacity-100 transition-all duration-200 text-[10px] text-muted/60 leading-relaxed">选择之前备份的 JSON 文件，自动按文件指纹匹配当前库中的音效，把标签、备注、收藏等数据合并回来（不会重复添加）</div>
              </div>
            </button>
